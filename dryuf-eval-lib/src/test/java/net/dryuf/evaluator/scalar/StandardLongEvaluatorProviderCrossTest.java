...
import net.dryuf.evaluator.MapContext;
import net.dryuf.evaluator.NullContext;
...
/**
 * Tests for {@link StandardLongEvaluatorProviderCrossTest}.
 */
public class StandardLongEvaluatorProviderCrossTest
{
	CustomizableEvaluatorFactory<?> factory = StandardLongEvaluatorProvider.populateAllAndBoolean(CustomizableEvaluatorFactory.builder()).build();
